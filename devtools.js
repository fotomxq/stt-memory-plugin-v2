...
export function installDevtools(hooks) {
    ...
    try {
        ...
        w.FTT = Object.assign({}, w.FTT || {}, {
            ...
            // v2.35.0（B10-a）：API 通道 / 预设 / 连通性 / 模型列表
            apiChannelSummary: () => (hooks && typeof hooks.apiChannelSummary === 'function' ? hooks.apiChannelSummary() : null),
            apiChannelAvailability: () => (hooks && typeof hooks.apiChannelAvailability === 'function' ? hooks.apiChannelAvailability() : null),
            apiProfiles: () => (hooks && typeof hooks.apiProfiles === 'function' ? hooks.apiProfiles() : { ok: false, profiles: [] }),
            apiTarget: (opts) => (hooks && typeof hooks.apiTarget === 'function' ? hooks.apiTarget(opts) : null),
            apiPresetNames: () => (hooks && typeof hooks.apiPresetNames === 'function' ? hooks.apiPresetNames() : []),
            apiPresetSave: (name) => (hooks && typeof hooks.apiPresetSave === 'function' ? hooks.apiPresetSave(name) : { ok: false }),
            apiPresetLoad: (name) => (hooks && typeof hooks.apiPresetLoad === 'function' ? hooks.apiPresetLoad(name) : { ok: false }),
            apiPresetDelete: (name) => (hooks && typeof hooks.apiPresetDelete === 'function' ? hooks.apiPresetDelete(name) : { ok: false }),
            apiTest: (opts) => (hooks && typeof hooks.apiTest === 'function' ? hooks.apiTest(opts) : Promise.resolve({ ok: false })),
            apiModels: (opts) => (hooks && typeof hooks.apiModels === 'function' ? hooks.apiModels(opts) : Promise.resolve({ ok: false })),
            apiSend: (opts) => (hooks && typeof hooks.apiSend === 'function' ? hooks.apiSend(opts) : Promise.resolve({ ok: false })),
            // v2.58.0：提取记忆三层（向量 / JS / AI）与向量缓存
            vectorLayerInfo: () => (hooks && typeof hooks.vectorLayerInfo === 'function' ? hooks.vectorLayerInfo() : null),
            vectorLayerStatus: () => (hooks && typeof hooks.vectorLayerStatus === 'function' ? hooks.vectorLayerStatus() : null),
            vectorTarget: (kind) => (hooks && typeof hooks.vectorTarget === 'function' ? hooks.vectorTarget(kind) : null),
            vectorRecall: (kw, opts) => (hooks && typeof hooks.vectorRecall === 'function' ? hooks.vectorRecall(kw, opts) : Promise.resolve({ ok: false })),
            embeddingsRequest: (texts) => (hooks && typeof hooks.embeddingsRequest === 'function' ? hooks.embeddingsRequest(texts) : Promise.resolve({ ok: false })),
            rerankRequest: (q, docs, n) => (hooks && typeof hooks.rerankRequest === 'function' ? hooks.rerankRequest(q, docs, n) : Promise.resolve({ ok: false })),
            vectorCacheStats: () => (hooks && typeof hooks.vectorCacheStats === 'function' ? hooks.vectorCacheStats() : null),
            vectorCacheClear: () => (hooks && typeof hooks.vectorCacheClear === 'function' ? hooks.vectorCacheClear() : Promise.resolve({ ok: false })),
            extractFlow: (text, opts) => (hooks && typeof hooks.extractFlow === 'function' ? hooks.extractFlow(text, opts) : Promise.resolve({ ok: false })),
            testLayer: (layer, text, opts) => (hooks && typeof hooks.testLayer === 'function' ? hooks.testLayer(layer, text, opts) : Promise.resolve({ ok: false })),
            aiLayerInfo: () => (hooks && typeof hooks.aiLayerInfo === 'function' ? hooks.aiLayerInfo() : null),
            aiKeywords: (text) => (hooks && typeof hooks.aiKeywords === 'function' ? hooks.aiKeywords(text) : Promise.resolve({ ok: false })),
            aiMemorySend: (kw, text, dump) => (hooks && typeof hooks.aiMemorySend === 'function' ? hooks.aiMemorySend(kw, text, dump) : Promise.resolve({ ok: false })),
