...
> 文档版本：v2.2.0 ｜ 日期：2026-09-24 ｜ 状态：**可用版本 v2.2.0**（P0–P8：内核/存储/注入/提取/UI 全链路 + **V1 同构面板（样式逐字对齐）**）
...
> 与 V1 的**功能**差距按批次推进：见 `docs/P8-功能对齐总表.md`（B1 已完成；B2–B9 待做，含 110 个 V1 面板动作清单）。
...
└── docs/                  # P0 探针报告 / 更新检查 / P1 内核平移 / P2 宿主与存储 / P3 注入闭环 / P3b 提取落库 / P4 提取编排 / P5 设定面板 / P5b 数据台 / P6 发布与终检 / P7 弹窗主界面 / P8 功能对齐总表 / P8b V1面板外壳 / 排障-面板不显示
```
