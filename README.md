...
> 文档版本：v2.0.0 ｜ 日期：2026-09-24 ｜ 状态：**首个可用版本 v2.0.0**（P0–P6 全阶段交付）
...
> 仓库地址（唯一）：`https://github.com/fotomxq/stt-memory-plugin-v2`；默认分支 `main`，首个可用版本标签 `v2.0.0`。
...
└── docs/                  # P0 探针报告 / 更新检查 / P1 内核平移 / P2 宿主与存储 / P3 注入闭环 / P3b 提取落库 / P4 提取编排 / P5 设定面板 / P5b 数据台 / P6 发布与终检
```
