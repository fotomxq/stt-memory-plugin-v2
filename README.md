...
> 文档版本：v2.5.0 ｜ 日期：2026-09-24 ｜ 状态：**可用版本 v2.5.0**（P0–P8：V1 同构面板；对齐进度 B1–B3 ✅、B4 首批 ✅）
...
> B4-2 与 B5–B9 待做（含 110 个 V1 面板动作清单与逐动作打勾表）：见 `docs/P8-功能对齐总表.md`、
> `docs/P8c-B2条目操作.md`、`docs/P8d-B3提取与楼层.md`、`docs/P8e-B4设定子页.md`。
...
└── docs/                  # P0 探针报告 / 更新检查 / P1 内核平移 / P2 宿主与存储 / P3 注入闭环 / P3b 提取落库 / P4 提取编排 / P5 设定面板 / P5b 数据台 / P6 发布与终检 / P7 弹窗主界面 / P8 功能对齐总表 / P8b V1面板外壳 / P8c B2条目操作 / P8d B3提取与楼层 / P8e B4设定子页 / 排障-面板不显示
```
